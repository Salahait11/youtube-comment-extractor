...
<body>
    ...
    async function getChannelId(identifier) {
        ...
        document.getElementById("extractCommentsProgress").innerText = translations[currentLanguage]['searchingChannel'] || "Recherche de l'ID de la chaîne..."; // Using the extractCommentsProgress to show channelId search
        ...
        try {
            ...
            if (response.channelId) {
                ...
                console.error("Channel ID not found:", response.error);
                alert(response.error || translations[currentLanguage]['noResultsFound']);
                return null;
            }
        } catch (error) {
            console.error("Error searching for channel:", error);
            alert(translations[currentLanguage]['genericError'] || "Une erreur s'est produite.");
            return null;
        } finally {
    ...
    async function extractCommentsFunc() {
        ...
        try {
            ...
            document.getElementById("comments").innerHTML = response.comments.length ? response.comments.join('<br><br>') : (translations[currentLanguage]['noComments'] || "Aucun commentaire trouvé.");
            displayDownloadLinks(response.comments, includeUsername, includeTimestamp, videoId);
        } catch (error) {
    ...
    async function getVideoInfoFunc() {
        ...
        try {
            ...
            document.getElementById("videoInfo").innerHTML = displayVideoInfoHtml(response);
    ...
    async function searchVideosFunc() {
        ...
        try {
            ...
            displaySearchResults(response, "searchVideosResults");
    ...
    async function channelVideosFunc() {
        ...
        try {
            ...
            displaySearchResults(response, "channelVideosResults");
        } catch (error) {
    ...
    async function channelPlaylistsFunc() {
        ...
        try {
            ...
            displaySearchResults(response, "channelPlaylistsResults");
        } catch (error) {
    ...
    async function playlistVideosFunc() {
        ...
        try {
            ...
            displaySearchResults(response, "playlistVideosResults");
